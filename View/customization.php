...
<body>
					...
					<div class="col-md-8 col-md-offset-2 text-center">
						<div class="display-t">
							<div class="display-tc animate-box" data-animate-effect="fadeIn">
								<h1>Customize your dream journal</h1>
							</div>
						</div>
					</div>
				</div>
		...
		<div id="fh5co-contact">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6">
						<h3>Start Customization</h3>
						<p>All customized journals have the same price.</p>
						<p>Price: GH₵ 2.00</p>
						<form action="../Actions/customizationprocess.php" enctype="multipart/form-data" method="POST">
							<div class="row form-group">
								<div class="col-md-6">
									<input type="file" class="form-control" id="image" name="journal_image" accept="image/*" placeholder="Journal image"><br>
								</div>
							...
							<div class="row form-group">
								<div class="col-md-12">
									...
									<textarea name="message" id="message" cols="30" rows="10" class="form-control" placeholder="Type your description for your journal" oninput="populate()"></textarea>
								</div>
							</div>
	...
	<?php if (isset($_GET['message'])) : ?>
		...
		<div class='message' data-id="<?php echo $_GET['message']; ?>"></div>
