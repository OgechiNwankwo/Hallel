...
session_start();
$all_journal = select_journal_ctr();
// print_r($all_journal);
?>
					...
					<div class="col-md-6 col-xs-6 text-center menu-1">
						<ul>
							...
							if (isset($_SESSION['Login'])) {
								...
								echo "<li><a href='../Functions/logout.php?logout=logout' class='btn-sm btn-danger '>Logout</a></li>";
							} else {
								...
								<div class="col-md-6 col-md-offset-3 col-md-pull-3 js-fullheight slider-text">
									<div class="slider-text-inner">
										<div class="desc">
											...
											<h2><?php echo $journal['journal_title'] ?></h2>
											<p><?php echo $journal['journal_desc'] ?></p>
											<p><a href=<?php echo "single.php?journal_id=" . $journal['journal_id'] ?> class="btn btn-primary btn-outline btn-lg">Purchase Now</a></p>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-md-4 text-center animate-box">
							<div class="product">
								<div class="product-grid" style=<?php echo "background-image:url({$journal['journal_image']})"; ?>>
									<div class="inner">
										<p>
											<!-- echo"../Actions/cartprocess.php?journal_id=".$id; -->
											<a href="../Actions/cartprocess.php?journal_id=<?php echo $journal['journal_id'] ?>" class="icon"><i class="icon-shopping-cart"></i></a>
