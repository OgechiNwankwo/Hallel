...
require("../Functions/display_customization.php");
?>
	...
	<div id="page">
								...
								<form action="search.php" method="POST">
									<div class="input-group">
										...
										<span class="input-group-btn">
											<a href="#" class="btn btn-warning " role="button" aria-pressed="true">Add Journal</a> 
											<button class="btn btn-warning" name="search" type="submit">Add Journal</button>
										</span>
									</div>
								</form>
							</li>
		...
		<div id="fh5co-product">
			<div class="container">
				...
				<?php showrandCustomizationTable_fnc(); ?>
